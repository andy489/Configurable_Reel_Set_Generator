...
public class ReaderManager {
    ...
    public static ReelSetsCollection readFile(String filePath, ObjectMapper objectMapper) throws IOException {
        try (FileReader reader = new FileReader(filePath)) {
            try {
                return objectMapper.readValue(new File(filePath), ReelSetsCollection.class);
